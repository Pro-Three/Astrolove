...
<div className="container cyan accent-4">
    <div class="menu">
          <div class="back"><i class="fa fa-chevron-left"></i> <img src={me} draggable="false" alt="pronounced 'em-aage'"/></div>
            <div class="name">Hamlet</div>
        </div>

    <ol class="chat">
    <li class="other">
        <div class="avatar"><img src="https://i.imgur.com/DY6gND0.png" draggable="false" alt="pronounced 'em-aage'"/></div>
      <div class="msg">
        <p>Hey, how are you?</p>
    ...
    <li class="self">
        <div class="avatar"><img src={me2} draggable="false" alt="pronounced 'em-aage'"/></div>
      <div class="msg">
    ...
    <li class="self">
        <div class="avatar"><img src="https://i.imgur.com/HYcn9xO.png" draggable="false" alt="pronounced 'em-aage'"/></div>
      <div class="msg">
      <h6 style={{textDecoration: 'underline'}}>William</h6>
    ...
    <li class="self">
        <div class="avatar"><img src="https://i.imgur.com/HYcn9xO.png" draggable="false" alt="pronounced 'em-aage'"/></div>
      <div class="msg">
        <img src="https://i.imgur.com/QAROObc.jpg" draggable="false" alt="words here"/>
        <h6 style={{textDecoration: 'underline'}}>William</h6>
